...
/**
 * A web service to retrieve the job and result metadata generated by SeqSearch.
 * @RestResource(
 *   id = "get-seqsearch-job",
 *   label = @Translation("ICTV SeqSearch: Get the job and result metadata generated by SeqSearch"),
 *   uri_paths = {
 *      "canonical" = "/get-seqsearch-job",
 *      "create" = "/get-seqsearch-job"
 *   }
 * )
 */
class GetSeqSearchJob extends ResourceBase {
   ...
   public function getJob(Request $request) {
      ...
      return SeqSearchJob::getJob($this->connection, $jobUID);
   }
