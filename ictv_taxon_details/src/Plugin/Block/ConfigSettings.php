...
// TODO: We should be using the ConfigSettings class in ictv_config, but this is a temporary hack for
// Taxon Details to work without having to update the ictv_config module (because so many things depend on it).
