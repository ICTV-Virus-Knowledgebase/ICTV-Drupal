...
class HistoricalTaxon {
   ...
   public int $mslReleaseNumber;
   public ?string $name;
   public ?string $previousNames;
   public ?string $prevNotes;
   public ?string $prevParentRank;
   public ?string $prevParentName;
   ...
   public static function fromArray(array $d): self {
      ...
      $o->selectedTaxon    = isset($d['selected_taxon']) ? (int)$d['selected_taxon'] : null;
      ...
      $o->leftIdx          = isset($d['left_idx']) ? (int)$d['left_idx'] : 0;
      $o->lineage          = $d['lineage'] ?? null;
      $o->lineageIDs       = $d['lineage_ids'] ?? null;
      $o->lineageRanks     = $d['rank_names'] ?? null;
      $o->modifications    = isset($d['modifications']) ? (int)$d['modifications'] : 0;
      $o->mslReleaseNumber = isset($d['msl_release_num']) ? (int)$d['msl_release_num'] : 0;
      $o->name             = $d['name'] ?? null;
      $o->previousNames    = $d['previous_names'] ?? null;
      $o->prevNotes        = $d['prev_notes'] ?? null;
      $o->prevParentRank   = $d['prev_parent_rank'] ?? null;
      $o->prevParentName   = $d['prev_parent_name'] ?? null;
