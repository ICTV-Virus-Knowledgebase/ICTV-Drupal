...
/**
 * A web service that retrieves an output file generated by a TaxaBLAST job.
 * @RestResource(
 *   id = "get-taxablast-output-file",
 *   label = @Translation("ICTV TaxaBLAST: Get an output file"),
 *   uri_paths = {
 *      "canonical" = "/get-taxablast-output-file",
 *      "create" = "/get-taxablast-output-file"
 *   }
 * )
 */
