...
/**
 * A web service to retrieve the job and result metadata generated by TaxaBLAST.
 * @RestResource(
 *   id = "get-taxablast-job",
 *   label = @Translation("ICTV TaxaBLAST: Get a user's TaxaBLAST job"),
 *   uri_paths = {
 *      "canonical" = "/get-taxablast-job",
 *      "create" = "/get-taxablast-job"
 *   }
 * )
 */
class GetTaxaBlastJob extends ResourceBase {
