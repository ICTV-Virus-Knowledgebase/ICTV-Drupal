...
CREATE TABLE `searchable_taxon` (
	...
	`filtered_name` VARCHAR(800) NOT NULL COMMENT 'The name with punctuation removed' COLLATE 'utf8mb4_general_ci',
   ...
   `is_valid` BIT(1) NOT NULL DEFAULT b'1' COMMENT 'Is this taxon information current/valid or obsolete?',
	`name` VARCHAR(800) NOT NULL COMMENT 'The taxon name' COLLATE 'utf8mb4_general_ci',
