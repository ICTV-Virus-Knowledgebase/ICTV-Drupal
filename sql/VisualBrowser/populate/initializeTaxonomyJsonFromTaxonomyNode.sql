...
--          06/28/24 dmd: Removed the species rank ID parameter, simplified the update of parent JSON IDs.
-- ==========================================================================================================
...
BEGIN
   ...
   BEGIN TRY
      ...
      -- Populate the parent JSON ID of all nodes initialized from taxonomy_node.
      UPDATE tj
